...
class CarbonEmissionsTool(SingleMessageCustomTool):
    ...
    def get_params_definition(self) -> Dict[str, ToolParamDefinitionParam]:
        ...
        return {
            ...
            "start_date": ToolParamDefinitionParam(
                param_type="str",
                description=(
                    "The start date for filtering carbon emissions data, in 'dd/mm/yyyy' format. "
                    "This is used to define the beginning of a date range for the query. "
                    "If not provided, data across all dates will be considered."
                ),
                required=False,
            ),
            "end_date": ToolParamDefinitionParam(
                param_type="str",
                description=(
                    "The end date for filtering carbon emissions data, in 'dd/mm/yyyy' format. "
                    "This is used to define the end of a date range for the query. "
                    "If not provided, data up to the most recent date will be considered."
                ),
                required=False,
            ),
        }
