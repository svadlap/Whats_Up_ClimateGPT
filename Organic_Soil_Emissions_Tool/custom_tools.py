...
class CustomTool:
    ...
    def parameters_for_system_prompt(self) -> str:
        return json.dumps({
            ...
            "parameters": {
                name: definition.__dict__ for name, definition in self.get_params_definition().items()
            },
        })
...
class SingleMessageCustomTool(CustomTool):
    ...
    allow for the tool to be called by the model and handle necessary plumbing.
    """
